...
def fill_in_libff_templates(outdir, curve_name, curve_family, modulus_r, R2_64_r, R3_64_r, inv_64_r, R2_32_r, R3_32_r, inv_32_r, num_bits_r, euler_r, s_r, t_r, t_minus_1_over_2_r, multiplicative_generator_r, root_of_unity_r, nqr_r, nqr_to_t_r, modulus_q, R2_64_q, R3_64_q, inv_64_q, R2_32_q, R3_32_q, inv_32_q, num_bits_q, euler_q, s_q, t_q, t_minus_1_over_2_q, multiplicative_generator_q, root_of_unity_q, nqr_q, nqr_to_t_q, euler_q2, s_q2, t_q2, t_minus_1_over_2_q2, non_residue_q2, nqr_q2, nqr_to_t_q2, frobenius_q2, non_residue_q6, frobenius_q6_1, frobenius_q6_2, mul_by_q, coeff_b, twist_coeff_b, twist_type, G1_one, G2_one, non_residue_q12, frobenius_q12, ate_loop_count, ate_loop_count_bool, final_exponent, poly_u, x_bool):
    ...
    init_cpp.write(renderer.render_path('./templates/init_cpp.mustache', 
        ...
        {'nqr_q2_c0': linearPoly2tab(nqr_q2)[0]},
        {'nqr_q2_c1': linearPoly2tab(nqr_q2)[1]},
        {'nqr_to_t_q2_c0': linearPoly2tab(nqr_to_t_q2)[0]},
        {'nqr_to_t_q2_c1': linearPoly2tab(nqr_to_t_q2)[1]},
        {'frobenius_q2_0': frobenius_q2[0]},
        {'frobenius_q2_1': frobenius_q2[1]},
        {'non_residue_q6_c0': linearPoly2tab(non_residue_q6)[0]},
        {'non_residue_q6_c1': linearPoly2tab(non_residue_q6)[1]},
        {'frobenius_q6_10_c0': linearPoly2tab(frobenius_q6_1[0])[0]},
        {'frobenius_q6_10_c1': linearPoly2tab(frobenius_q6_1[0])[1]},
        {'frobenius_q6_11_c0': linearPoly2tab(frobenius_q6_1[1])[0]},
        {'frobenius_q6_11_c1': linearPoly2tab(frobenius_q6_1[1])[1]},
        {'frobenius_q6_12_c0': linearPoly2tab(frobenius_q6_1[2])[0]},
        {'frobenius_q6_12_c1': linearPoly2tab(frobenius_q6_1[2])[1]},
        {'frobenius_q6_13_c0': linearPoly2tab(frobenius_q6_1[3])[0]},
        {'frobenius_q6_13_c1': linearPoly2tab(frobenius_q6_1[3])[1]},
        {'frobenius_q6_14_c0': linearPoly2tab(frobenius_q6_1[4])[0]},
        {'frobenius_q6_14_c1': linearPoly2tab(frobenius_q6_1[4])[1]},
        {'frobenius_q6_15_c0': linearPoly2tab(frobenius_q6_1[5])[0]},
        {'frobenius_q6_15_c1': linearPoly2tab(frobenius_q6_1[5])[1]},
        {'non_residue_q6_c0': linearPoly2tab(non_residue_q6)[0]},
        {'non_residue_q6_c1': linearPoly2tab(non_residue_q6)[1]},
        {'frobenius_q6_20_c0': linearPoly2tab(frobenius_q6_2[0])[0]},
        {'frobenius_q6_20_c1': linearPoly2tab(frobenius_q6_2[0])[1]},
        {'frobenius_q6_21_c0': linearPoly2tab(frobenius_q6_2[1])[0]},
        {'frobenius_q6_21_c1': linearPoly2tab(frobenius_q6_2[1])[1]},
        {'frobenius_q6_22_c0': linearPoly2tab(frobenius_q6_2[2])[0]},
        {'frobenius_q6_22_c1': linearPoly2tab(frobenius_q6_2[2])[1]},
        {'frobenius_q6_23_c0': linearPoly2tab(frobenius_q6_2[3])[0]},
        {'frobenius_q6_23_c1': linearPoly2tab(frobenius_q6_2[3])[1]},
        {'frobenius_q6_24_c0': linearPoly2tab(frobenius_q6_2[4])[0]},
        {'frobenius_q6_24_c1': linearPoly2tab(frobenius_q6_2[4])[1]},
        {'frobenius_q6_25_c0': linearPoly2tab(frobenius_q6_2[5])[0]},
        {'frobenius_q6_25_c1': linearPoly2tab(frobenius_q6_2[5])[1]},
        {'mul_by_q_0_c0': linearPoly2tab(mul_by_q[0])[0]},
        {'mul_by_q_0_c1': linearPoly2tab(mul_by_q[0])[1]},
        {'mul_by_q_1_c0': linearPoly2tab(mul_by_q[1])[0]},
        {'mul_by_q_1_c1': linearPoly2tab(mul_by_q[1])[1]},
        {'coeff_b': coeff_b},
        {'twist_coeff_b_c0': linearPoly2tab(twist_coeff_b)[0]},
        {'twist_coeff_b_c1': linearPoly2tab(twist_coeff_b)[1]},
        {'twist_type': twist_type},
        {'G1_one_x': G1_one[0]},
        {'G1_one_y': G1_one[1]},
        {'G2_one_x_c0': linearPoly2tab(G2_one[0])[0]},
        {'G2_one_x_c1': linearPoly2tab(G2_one[0])[1]},
        {'G2_one_y_c0': linearPoly2tab(G2_one[1])[0]},
        {'G2_one_y_c1': linearPoly2tab(G2_one[1])[1]},
        {'non_residue_q12_c0': linearPoly2tab(non_residue_q12)[0]},
        {'non_residue_q12_c1': linearPoly2tab(non_residue_q12)[1]},
        {'frobenius_q12_0_c0': linearPoly2tab(frobenius_q12[0])[0]},
        {'frobenius_q12_1_c0': linearPoly2tab(frobenius_q12[1])[0]},
        {'frobenius_q12_2_c0': linearPoly2tab(frobenius_q12[2])[0]},
        {'frobenius_q12_3_c0': linearPoly2tab(frobenius_q12[3])[0]},
        {'frobenius_q12_4_c0': linearPoly2tab(frobenius_q12[4])[0]},
        {'frobenius_q12_5_c0': linearPoly2tab(frobenius_q12[5])[0]},
        {'frobenius_q12_6_c0': linearPoly2tab(frobenius_q12[6])[0]},
        {'frobenius_q12_7_c0': linearPoly2tab(frobenius_q12[7])[0]},
        {'frobenius_q12_8_c0': linearPoly2tab(frobenius_q12[8])[0]},
        {'frobenius_q12_9_c0': linearPoly2tab(frobenius_q12[9])[0]},
        {'frobenius_q12_10_c0': linearPoly2tab(frobenius_q12[10])[0]},
        {'frobenius_q12_11_c0': linearPoly2tab(frobenius_q12[11])[0]},
        {'frobenius_q12_0_c1': linearPoly2tab(frobenius_q12[0])[1]},
        {'frobenius_q12_1_c1': linearPoly2tab(frobenius_q12[1])[1]},
        {'frobenius_q12_2_c1': linearPoly2tab(frobenius_q12[2])[1]},
        {'frobenius_q12_3_c1': linearPoly2tab(frobenius_q12[3])[1]},
        {'frobenius_q12_4_c1': linearPoly2tab(frobenius_q12[4])[1]},
        {'frobenius_q12_5_c1': linearPoly2tab(frobenius_q12[5])[1]},
        {'frobenius_q12_6_c1': linearPoly2tab(frobenius_q12[6])[1]},
        {'frobenius_q12_7_c1': linearPoly2tab(frobenius_q12[7])[1]},
        {'frobenius_q12_8_c1': linearPoly2tab(frobenius_q12[8])[1]},
        {'frobenius_q12_9_c1': linearPoly2tab(frobenius_q12[9])[1]},
        {'frobenius_q12_10_c1' : linearPoly2tab(frobenius_q12[10])[1]},
        {'frobenius_q12_11_c1' : linearPoly2tab(frobenius_q12[11])[1]},
